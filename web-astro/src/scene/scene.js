...
const LOCKED_NODES = [
  {a:[0.4976,0.3467], hi:null,             ho:[0.5352,0.3488]},
  {a:[0.5520,0.3671], hi:[0.5449,0.3424],  ho:[0.5587,0.3811]},
  {a:[0.5661,0.4426], hi:[0.5661,0.4013],  ho:[0.5647,0.5438]},
  {a:[0.5042,0.6333], hi:[0.5048,0.6139],  ho:[0.5042,0.6724]},   // neck (founder re-traced 2026-07-29)
  {a:[0.5637,0.8121], hi:[0.5637,0.7216],  ho:[0.5637,0.8326]},
  {a:[0.5522,0.8757], hi:[0.5631,0.8520],  ho:[0.5510,0.8735]},
  {a:[0.5006,0.8843], hi:[0.5297,0.8843],  ho:null},
];
