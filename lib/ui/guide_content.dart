...
const kSustain101 = <GuideChapter>[
  ...
  GuideChapter('Your Numbers', 'What every figure on your stats means, and which mode each one counts.', [
    GuideTopic(
      ...
      ['Today — focus logged since midnight, across every mode.', 'Current streak — consecutive days, counting back from today, with any focus at all.', 'Total focus — your lifetime focus across every session.', 'Average session — your typical focused time per session (a Pro stat).', 'Best streak — the longest run of consecutive focused days you have ever had.', 'Longest session — your single longest unbroken block of recorded focus.', 'Sessions — the number of sessions that recorded real focus.', 'Completed — sessions carried all the way to the finish. The only figure that requires a fully completed session.', 'Active days — days that hold real focus (lifetime, and over the last 30 days).', 'Focusing since — the date of your very first focused session.'],
    ),
    GuideTopic(
      'Streaks and the heatmap',
      'A streak is a run of consecutive calendar days with at least one focused session on each. Your current streak counts back from today; the moment you focus for any length, today counts. Ending a session early still counts — the streak cares that you showed up, not how the session finished.\n\nThe consistency heatmap is a grid of the last fifteen weeks, one square per day, weeks starting on Sunday. A square shades up as the day\'s focus passes roughly fifteen minutes, thirty, and an hour. Tap any square to read that day\'s focus and session count.',
  ...
  GuideChapter('Insights', 'The full picture of your focus — what is free, what comes with Pro, and how each chart stays honest.', [
    ...
    GuideTopic(
      'Exporting your data',
      'Your history is yours, and you can take a copy two ways.\n\nFrom Insights, Export PDF report builds a clean, shareable Focus Report — your whole story in one document: a summary, your Focus Score, the records scorecard, focus over time, where your time goes by mode, when you focus, consistency and streaks, follow-through, your personal bests, and a short glossary. Focus Stamina is included for Pro. It saves as sustain-focus-report.pdf.\n\nFrom the History screen, the share icon exports your raw session history as a CSV, saved as sustain-focus-history.csv. Its columns are startedAt, mode, plannedMinutes, focusedMinutes, completed, abandoned, and intention — yours to keep or open in any spreadsheet.',
      ['PDF report (Insights) — the narrative, formatted to read and share.', 'CSV export (History) — the raw rows, for your own analysis.', 'Your data lives only on your device until you choose to share it.'],
    ),
  ]),
  ...
  GuideChapter('Sustain Pro', 'What Pro unlocks, the three ways to get it, and restoring it.', [
    GuideTopic(
      ...
      ['Your full analytics: Focus Score and Focus Stamina over time, Average session, and Follow-through', 'Your peak focus window and your personal-bests timeline', 'A detailed PDF report and CSV data export', 'Every color theme, now and every one added later', 'Unlimited, longer pauses mid-session (up to 10 minutes each)', 'Session reuse — start again from a past session\'s setup', 'Every Pro feature added in future, included'],
    ),
    GuideTopic(
      'The three tiers',
      'Pro comes three ways, all yours to use offline once unlocked. Monthly is the low-barrier way to try Pro. Yearly is the best value and where most people land. Lifetime is a single one-time payment — Pro forever, with no subscription and no renewal.\n\nMonthly and Yearly auto-renew until you cancel, which you can do any time via Manage subscription (it opens Google Play). Lifetime and à la carte theme purchases are one-time and never expire.\n\nPrices are shown live from the store in your local currency, so this guide does not list them — open Settings, Sustain Pro to see current prices.',
    ),
    GuideTopic(
