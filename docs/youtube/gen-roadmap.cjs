...
// THUMBNAIL says BELL ONLY, the TITLE says No Music. Not a contradiction — they have different jobs.
// "No music" is the query (study with me no music 25,548 · pomodoro no music 9,661) and searchers use
// it loosely to mean any audio bed, so the title keeps it. But nothing in this catalogue has music:
