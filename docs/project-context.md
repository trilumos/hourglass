...
- **V1 LAUNCH CHECKLIST — ✅ DONE, v1 is PUBLISHED** (verified 2026-07-11; Product Hunt launch 2026-07-17; `pubspec.yaml` = 1.0.0+5). `docs/v1-launch-checklist.md` is now the **historical record** of what was gated, not a todo list. Still outstanding from the launch: **no snapshot/tag of the published commit exists** — see `docs/feature-roadmap.md`.
